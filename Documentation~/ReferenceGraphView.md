...
- **Expandable References**: Click the [+] button on a node to see all objects that reference it
...
2. **Expand References**: Click the [+] button on a node to see which objects reference it
